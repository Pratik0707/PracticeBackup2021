...
public class LoginSteps_POM {
	...
	/*
	 * WebDriver dr = null; LoginPage lp;
	 * 
	 * @Given("I am on login page of the application") public void
	 * i_am_on_login_page_of_the_application() { System.out.println("=== POM ===");
	 ...
	 * }
	 * 
	 * @When("^I Enter a valid (.*)$") public void i_enter_a_valid_username(String
	 * username) { lp = new LoginPage(dr); lp.EnterUserName(username); }
	 * 
	 * @And("^I enter a valid (.*)$") public void i_enter_a_valid_password(String
	 * password) { lp.EnterPassword(password); }
	 * 
	 * @And("I click on Login button") public void i_click_on_login_button() throws
	 * InterruptedException { Thread.sleep(1500); lp.ClickLoginButon(); }
	 * 
