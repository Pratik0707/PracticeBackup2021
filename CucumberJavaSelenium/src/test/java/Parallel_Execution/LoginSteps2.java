...
public class LoginSteps2 {
	...
	@Given("I am on login page of the application2") public void
	...
	@When("^I Enter a valid2 (.*)$") public void i_enter_a_valid_username(String username) 
	{ 
		dr.findElement(By.id("name")).sendKeys(username); 
	}

	@And("^I enter a valid2 (.*)$") public void i_enter_a_valid_password(String
			password) { dr.findElement(By.id("password")).sendKeys(password); }

	@And("I click on Login button2") public void i_click_on_login_button() throws
	InterruptedException { Thread.sleep(1500);
	dr.findElement(By.id("login")).click(); }

	@Then("I Successfully login to the application2") public void
